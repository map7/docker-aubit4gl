...
ENV A4GL_UI "TUI"
ENV A4GL_SQLTYPE "esql"

RUN apt-get update && apt-get install -y wget build-essential autoconf bison gdb valgrind curl libncurses5 postgresql bash libncurses5-dev libncursesw5-dev pkg-config flex iodbc unixodbc libecpg-dev libglib2.0-dev doxygen cvs splint expect texi2html libgmp3-dev perl-doc gawk libsigsegv2 sqlite libglade2-dev mg
